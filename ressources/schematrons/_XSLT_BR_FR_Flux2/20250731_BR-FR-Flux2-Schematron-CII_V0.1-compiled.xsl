...
<xsl:stylesheet xmlns:custom="http://www.example.org/custom"
                ...
                version="2.0"
                xml:base="file:/Users/cyrille/Documents/_Cyrille_Boulot/ADMAREL_2025/_FNFE_2025/_Commission_AFNOR/_REVUE%20Commentaires%20Normes/_Schematrons/20250731_BR-FR-Flux2-Schematron-CII_V0.1.sch_xslt_cascade"><!--Implementers: please note that overriding process-prolog or process-root is 
   ...
   <xsl:template match="rsm:CrossIndustryInvoice" priority="1000" mode="M48">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text> BR-FR-CO-10/EXT-FR-FE-69 : Si l’identifiant global de l’agent commercial est renseigné, alors son schéma doit également être renseigné. </xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text> BR-FR-CO-10/EXT-FR-FE-92 : Si l’identifiant global du destinataire de la facture est renseigné, alors son schéma doit également être renseigné. </xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text> BR-FR-CO-10/EXT-FR-FE-115 : Si l’identifiant global de l’émetteur de la facture est renseigné, alors son schéma doit également être renseigné. </xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text> BR-FR-CO-10/BT-71 : Si l’identifiant global du lieu de livraison (en-tête) est renseigné, alors son schéma doit également être renseigné. </xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text> BR-FR-CO-10/EXT-FR-FE-146 : Si l’identifiant global du lieu de livraison (ligne) est renseigné, alors son schéma doit également être renseigné. </xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="@*|*" mode="M48"/>
