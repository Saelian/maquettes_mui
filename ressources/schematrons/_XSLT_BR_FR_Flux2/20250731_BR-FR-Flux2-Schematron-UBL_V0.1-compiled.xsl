...
<xsl:stylesheet xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
                ...
                version="2.0"
                xml:base="file:/Users/cyrille/Documents/_Cyrille_Boulot/ADMAREL_2025/_FNFE_2025/_Commission_AFNOR/_REVUE%20Commentaires%20Normes/_Schematrons/20250731_BR-FR-Flux2-Schematron-UBL_V0.1.sch_xslt_cascade"><!--Implementers: please note that overriding process-prolog or process-root is 
   ...
   <xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:DocumentReference/cbc:IssueDate | cn:CreditNote/cac:CreditNoteLine/cac:DocumentReference/cbc:IssueDate"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text> EXT-FR-FE-138 : La date d’émission de la facture référencée en ligne (qdt:DateTimeString) doit contenir une année entre 2000 et 2099. Valeur actuelle : "</xsl:text>
               <xsl:text/>
               <xsl:value-of select="."/>
               <xsl:text/>
               <xsl:text>". Veuillez vérifier la validité de la date. </xsl:text>
   ...
   <xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:Delivery/cbc:ActualDeliveryDate | cn:CreditNote/cac:CreditNoteLine/cac:Delivery/cbc:ActualDeliveryDate"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text> EXT-FR-FE-158 : La date de livraison effective en ligne (udt:DateTimeString) doit contenir une année entre 2000 et 2099. Valeur actuelle : "</xsl:text>
               <xsl:text/>
               <xsl:value-of select="."/>
               <xsl:text/>
               <xsl:text>". Veuillez vérifier la validité de la date. </xsl:text>
   ...
   <xsl:template match="ubl:Invoice | cn:CreditNote" priority="1000" mode="M49">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text> BR-FR-CO-10/BT-29 : Si l’identifiant global du fournisseur (BT-29) est renseigné, alors son schéma (BT-29-1) doit également être renseigné. </xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text> BR-FR-CO-10/BT-46 : Si l’identifiant global du client (BT-46) est renseigné, alors son schéma doit également être renseigné. </xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text> BR-FR-CO-10/BT-60 : Si l’identifiant global du bénéficiaire (BT-60) est renseigné, alors son schéma doit également être renseigné. </xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text> BR-FR-CO-10/EXT-FR-FE-06 : Si l’identifiant global de l’agent du client est renseigné, alors son schéma doit également être renseigné. </xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text> BR-FR-CO-10/EXT-FR-FE-46 : Si l’identifiant global du payeur est renseigné, alors son schéma doit également être renseigné. </xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text> BR-FR-CO-10/EXT-FR-FE-69 : Si l’identifiant global de l’agent du fournisseur est renseigné, alors son schéma doit également être renseigné. </xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text> BR-FR-CO-10/EXT-FR-FE-92 : Si l’identifiant global du prestataire de services du client est renseigné, alors son schéma doit également être renseigné. </xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text> BR-FR-CO-10/EXT-FR-FE-115 : Si l’identifiant global du prestataire de services du fournisseur est renseigné, alors son schéma doit également être renseigné. </xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="@*|*" mode="M49"/>
