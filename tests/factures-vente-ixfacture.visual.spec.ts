...
/**
 * Test visuel pour vérifier l'alignement et l'apparence de la maquette FacturesVenteIxfacture
 */
test.describe('Vérification visuelle - FacturesVenteIxfacture', () => {
  test('FacturesVenteIxfacture - Vérification de l\'alignement', async ({ page }) => {
    // Naviguer vers la maquette
    await page.goto('/factures-vente-ixfacture');
    ...
    await page.screenshot({
      path: 'tests/screenshots/factures-vente-ixfacture-full.png',
      fullPage: true
    });
    ...
    await toolbar.screenshot({
      path: 'tests/screenshots/factures-vente-ixfacture-toolbar.png'
    });
  ...
  test('FacturesVenteIxfacture - Vérification de la modale de détail', async ({ page }) => {
    // Naviguer vers la maquette
    await page.goto('/factures-vente-ixfacture');
    ...
    await modale.screenshot({
      path: 'tests/screenshots/factures-vente-ixfacture-modale.png'
    });
    ...
    await expect(page.getByLabel(/Centre de profit/i).first()).toBeVisible();
    await expect(page.getByLabel(/Projet/i).first()).toBeVisible();
